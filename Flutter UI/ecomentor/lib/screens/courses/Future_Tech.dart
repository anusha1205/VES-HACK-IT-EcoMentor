...
import 'package:ecomentor/screens/courses/Future_Tech/c4_video_2.dart';
import 'package:ecomentor/screens/courses/Future_Tech/c4_video_1.dart';

class Future_Tech extends StatelessWidget {
  const Future_Tech({super.key});
        ...
        child: Column(
          ...
          children: [
            ...
            _buildVideoTile(
              ...
              destinationPage: const C4_video_1(),
            ),
            ...
            _buildVideoTile(
              ...
              destinationPage: const C4_video_2(),
            ),
          ],
        ),
      ),
